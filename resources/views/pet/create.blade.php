...
<div class="container-xxl p-4">
  ...
  @include('includes.alertError')  
    ...
    <form action="{{ route("pet.store") }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mt-2">
            <div class="col-md-4">
                <div id="carouselExampleIndicators" class="carousel slide carousel-dark slide" data-bs-ride="carousel" data-bs-interval="false">
            ...
            $.ajax({
                ...
                success: function (data) {
                    $.each(data, function() {
                        ...
                        if(this.id == oldSpecieId) {
                            $("#breed_id option[value=" + oldSpecieId + "]").prop("selected", true)
                        }
                    })
                },
                error: function (data) {
